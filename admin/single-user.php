                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="authname"
                                    value="<?php echo $usrupdata['ar_authorname']; ?>"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="authusername"
                                    value="<?php echo $usrupdata['ar_username']; ?>" placeholder="User Name Here"
                                    disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="email" class="form-control" id="authemail"
                                    value="<?php echo $usrupdata['ar_authemail']; ?>" placeholder="Author Email Here"
                                    required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="authcompany"
                                    value="<?php echo $usrupdata['ar_company']; ?>" placeholder="Company Name Here">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="authavtar"
